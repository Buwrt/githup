...
data class Repository(
    ...
    @SerializedName("allow_forking") val allowForking: Boolean = true,
    ...
    @SerializedName("temp_clone_token") val tempCloneToken: String? = null,
    @SerializedName("network_count") val networkCount: Int = 0,
